...
param.out_path = ['..' FILE_SEP '02_Speech_Data' FILE_SEP 'CSTR-VCTK' FILE_SEP 'VCTK8_seenETSI_exp005_ImageFE_16_DT_test' FILE_SEP];
...
param.numNE             = 25;                   % number of NE signals for each speaker
...
param.SNR               = [0, 5, 10, 15, 20, 25, 30];           % randomly chosen from list
